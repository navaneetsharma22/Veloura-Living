...
export function CustomerStory({ story }) {
    ...
    <Section spacing="spacious" containerWidth="wide" bg="default" className="border-t border-[var(--color-border-soft)]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div ref={contentRef} className="flex flex-col order-2 lg:order-1">
          ...
          <blockquote className="reveal-story-txt font-heading text-2xl lg:text-4xl font-medium text-[var(--text-heading)] leading-snug mb-10 italic">
            "{story.quote}"
          </blockquote>
          
          <div className="reveal-story-txt flex items-center gap-4">
            <div className="w-12 h-12 rounded-full border border-[var(--color-border-soft)] flex items-center justify-center bg-[var(--bg-surface)] shadow-sm">
        ...
        {/* Right: Image */}
        <div className="order-1 lg:order-2 relative w-full aspect-square lg:aspect-[4/5] rounded-2xl overflow-hidden shadow-xl reveal-story-txt">
          <Image
            src={story.image}
            alt="Customer lifestyle photography"
            fill
