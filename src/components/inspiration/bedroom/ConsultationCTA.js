...
export function ConsultationCTA() {
  ...
  return (
    <Section spacing="spacious" containerWidth="wide" bg="default" className="border-t border-[var(--color-border-soft)]">
      <div 
        ref={ctaRef} 
        className="w-full flex flex-col items-center justify-center text-center max-w-3xl mx-auto"
      >
        ...
        <p className="reveal-consult-cta font-body text-lg text-[var(--text-body)] mb-12">
          Collaborate with our interior designers to craft a bedroom that combines timeless elegance with everyday comfort.
        </p>
