    ...
    <Section spacing="standard" containerWidth="narrow" bg="default">
      ...
      <div ref={cardsRef} className="flex flex-col gap-6">
        {tips.map((tip, index) => (
          <div 
            key={index} 
            className="reveal-tip-card p-8 lg:p-10 rounded-2xl bg-[var(--color-neutral-100)] border border-[var(--color-border-soft)] hover:shadow-lg transition-shadow duration-300"
          >
