...
export function DecorCTA() {
  const ctaRef = useStaggerReveal(".reveal-decor-cta", {
    start: "top 90%",
    stagger: 0.1,
  });
  ...
  return (
    <Section spacing="spacious" containerWidth="wide" bg="light" className="border-t border-[var(--color-border-soft)]">
      ...
      >
        <h2 className="reveal-decor-cta font-heading text-4xl md:text-5xl font-medium text-[var(--text-heading)] mb-6">
          Complete Every Space with Thoughtful Details
        </h2>
        
        <p className="reveal-decor-cta font-body text-base text-[var(--text-body)] mb-10">
          Discover carefully curated decorative pieces that add warmth, personality, and timeless elegance to every room.
        </p>
        
        <div className="reveal-decor-cta flex flex-col sm:flex-row gap-4">
          <Link 
            href="/consultation"
