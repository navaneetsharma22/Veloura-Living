...
export function DiningFurniture({ categories }) {
        ...
        {categories.map((category) => (
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[rgba(25,20,17,0.85)] via-[rgba(25,20,17,0.2)] to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-500" />
            </div>
