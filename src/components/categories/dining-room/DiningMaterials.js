...
export function DiningMaterials({ materials }) {
    ...
    <Section spacing="standard" containerWidth="wide" bg="default" className="border-t border-[var(--color-border-soft)]">
      <div className="mb-12 lg:mb-16">
        <SectionHeading
          ...
          description="We select materials that invite touch and withstand the rigors of entertaining. From organic travertine to grounding solid oak, these surfaces age gracefully."
          align="center"
        />
      </div>
