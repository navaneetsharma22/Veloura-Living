...
export function StorageMaterials({ materials }) {
    ...
    <Section spacing="standard" containerWidth="wide" bg="default" className="border-t border-[var(--color-border-soft)]">
      <div className="mb-12 lg:mb-16">
        <SectionHeading
          ...
          description="We construct our storage systems from incredibly dense, premium materials designed to handle the daily friction of everyday life while maintaining their flawless appearance."
          align="center"
        />
      </div>
