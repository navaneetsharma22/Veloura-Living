...
export function KitchenFurniture({ categories }) {
        ...
        {categories.map((category) => (
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[rgba(30,28,26,0.85)] via-[rgba(30,28,26,0.2)] to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-500" />
            </div>
