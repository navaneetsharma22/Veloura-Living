...
export function KitchenHero({ content }) {
    ...
    <section className="relative w-full h-[85vh] min-h-[600px] flex flex-col justify-between overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        {/* Soft elegant gradient overlay tailored for a warm kitchen feel */}
        <div className="absolute inset-0 bg-gradient-to-t from-[rgba(23,21,20,0.85)] via-[rgba(23,21,20,0.3)] to-[rgba(23,21,20,0.1)]" />
      </div>
