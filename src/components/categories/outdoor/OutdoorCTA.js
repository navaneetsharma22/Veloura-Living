...
export function OutdoorCTA() {
  const ctaRef = useStaggerReveal(".reveal-outdoor-cta", {
    start: "top 90%",
    stagger: 0.1,
  });
  ...
  return (
    <Section spacing="spacious" containerWidth="wide" bg="light" className="border-t border-[var(--color-border-soft)]">
      ...
      >
        <h2 className="reveal-outdoor-cta font-heading text-4xl md:text-5xl font-medium text-[var(--text-heading)] mb-6">
          Create an Outdoor Space Worth Living In
        </h2>
        
        <p className="reveal-outdoor-cta font-body text-base text-[var(--text-body)] mb-10">
          Design a luxurious outdoor retreat with timeless furniture crafted for comfort, beauty, and every season.
        </p>
        
        <div className="reveal-outdoor-cta flex flex-col sm:flex-row gap-4">
          <Link 
            href="/contact"
