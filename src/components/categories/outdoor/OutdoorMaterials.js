...
export function OutdoorMaterials({ materials }) {
    ...
    <Section spacing="standard" containerWidth="wide" bg="default" className="border-t border-[var(--color-border-soft)]">
      <div className="mb-12 lg:mb-16">
        <SectionHeading
          ...
          title="Engineered for the Elements"
          description="We select materials that combine rigorous structural integrity with tactile warmth, ensuring your outdoor spaces weather gracefully through every season."
          align="center"
        />
      </div>
