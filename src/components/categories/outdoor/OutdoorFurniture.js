...
export function OutdoorFurniture({ categories }) {
  // Removed GSAP stagger reveal to prevent fading bugs

  return (
    <Section id="furniture-showcase" spacing="spacious" containerWidth="wide" bg="light">
        ...
        {categories.map((category) => (
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[rgba(30,26,22,0.85)] via-[rgba(30,26,22,0.2)] to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-500" />
            </div>
