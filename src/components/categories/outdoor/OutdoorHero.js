...
export function OutdoorHero({ content }) {
    ...
    <section className="relative w-full h-[85vh] min-h-[600px] flex flex-col justify-between overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        {/* Soft elegant gradient overlay tailored for a golden-hour outdoor feel */}
        <div className="absolute inset-0 bg-gradient-to-t from-[rgba(26,24,21,0.85)] via-[rgba(26,24,21,0.3)] to-[rgba(26,24,21,0.1)]" />
      </div>
