...
export function MaterialHighlights({ materials }) {
    ...
    <Section spacing="standard" containerWidth="wide" bg="default" className="border-t border-[var(--color-border-soft)]">
      <div className="mb-12 lg:mb-16">
        <SectionHeading
          ...
          description="Every living room piece is constructed using sustainably sourced hardwoods, highly durable textiles, and premium natural stones that only grow more beautiful with time."
          align="center"
        />
      </div>
