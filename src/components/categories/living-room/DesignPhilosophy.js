...
export function DesignPhilosophy({ content }) {
  ...
  return (
    <Section spacing="spacious" containerWidth="wide" bg="light" className="overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="relative w-full aspect-[4/5] rounded-2xl overflow-hidden shadow-xl">
          ...
          <div className="absolute inset-4 border border-white/30 rounded-xl z-10 pointer-events-none mix-blend-overlay" />
        </div>
