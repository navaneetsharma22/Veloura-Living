...
export function LivingCTA() {
  const ctaRef = useStaggerReveal(".reveal-living-cta", {
    start: "top 90%",
    stagger: 0.1,
  });
  ...
  return (
    <Section spacing="spacious" containerWidth="wide" bg="light" className="border-t border-[var(--color-border-soft)]">
      ...
      >
        <h2 className="reveal-living-cta font-heading text-4xl md:text-5xl font-medium text-[var(--text-heading)] mb-6">
          Create Your Perfect Living Room
        </h2>
        
        <p className="reveal-living-cta font-body text-base text-[var(--text-body)] mb-10">
          Book a complimentary consultation with our design specialists to curate a space that perfectly aligns with your lifestyle and architectural aesthetic.
        </p>
        
        <div className="reveal-living-cta flex flex-col sm:flex-row gap-4">
          <Link 
            href="/contact"
