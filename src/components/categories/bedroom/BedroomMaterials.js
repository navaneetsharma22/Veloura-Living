...
export function BedroomMaterials({ materials }) {
    ...
    <Section spacing="standard" containerWidth="wide" bg="default" className="border-t border-[var(--color-border-soft)]">
      <div className="mb-12 lg:mb-16">
        <SectionHeading
          ...
          title="Tactile Tranquility"
          description="We select materials that invite touch and foster rest. From breathable Belgian linen to the grounding warmth of solid oak."
          align="center"
        />
      </div>
