...
export function MirrorsHero({ content }) {
    ...
    <section className="relative w-full h-[85vh] min-h-[600px] flex flex-col justify-between overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        {/* Soft elegant gradient overlay tailored for a warm, styled feel */}
        <div className="absolute inset-0 bg-gradient-to-t from-[rgba(33,31,29,0.85)] via-[rgba(33,31,29,0.3)] to-[rgba(33,31,29,0.1)]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 md:px-8 xl:px-12 pt-8">
        <Breadcrumb 
          items={[
            ...
            { label: 'Mirrors', href: '/categories/Mirrors' },
          ]} 
          theme="dark"
        />
      </div>
