...
export function MirrorsMaterials({ materials }) {
    ...
    <Section spacing="standard" containerWidth="wide" bg="default" className="border-t border-[var(--color-border-soft)]">
      <div className="mb-12 lg:mb-16">
        <SectionHeading
          ...
          description="We select materials that combine striking visual texture with undeniable physical weight, ensuring every Mirrorsative piece commands presence in a room."
          align="center"
        />
      </div>
