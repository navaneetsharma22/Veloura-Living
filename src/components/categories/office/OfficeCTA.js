...
export function OfficeCTA() {
  const ctaRef = useStaggerReveal(".reveal-office-cta", {
    start: "top 90%",
    stagger: 0.1,
  });
  ...
  return (
    <Section spacing="spacious" containerWidth="wide" bg="light" className="border-t border-[var(--color-border-soft)]">
      ...
      >
        <h2 className="reveal-office-cta font-heading text-4xl md:text-5xl font-medium text-[var(--text-heading)] mb-6">
          Design a Workspace That Inspires Success
        </h2>
        
        <p className="reveal-office-cta font-body text-base text-[var(--text-body)] mb-10">
          Create a refined office where productivity, comfort, and timeless craftsmanship come together.
        </p>
