...
export function OfficeMaterials({ materials }) {
    ...
    <Section spacing="standard" containerWidth="wide" bg="default" className="border-t border-[var(--color-border-soft)]">
      <div className="mb-12 lg:mb-16">
        <SectionHeading
          ...
          description="We select materials that combine rigorous structural integrity with tactile warmth. From architectural steel to supple Italian leather."
          align="center"
        />
      </div>
