...
export function OfficeHero({ content }) {
    ...
    <section className="relative w-full h-[85vh] min-h-[600px] flex flex-col justify-between overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        {/* Soft elegant gradient overlay tailored for a focused office feel */}
        <div className="absolute inset-0 bg-gradient-to-t from-[rgba(23,25,28,0.85)] via-[rgba(23,25,28,0.3)] to-[rgba(23,25,28,0.1)]" />
      </div>
