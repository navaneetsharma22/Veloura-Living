export const livingRoomData = {
  ...
  customerStory: {
    quote: "Veloura's living collection completely transformed how we interact with our space. The low-profile sofa grounds the room, while the solid oak accents bring a warmth that feels instantly like home.",
    name: "Sarah & James",
  ...
  faqs: [
    {
      question: "Are the sofas customizable?",
      answer: "Yes, our luxury sofas are available in over 20 premium fabrics and leathers, as well as multiple modular configurations to perfectly fit your space."
    },
    {
      question: "How do I care for my Italian marble coffee table?",
      answer: "We recommend wiping spills immediately with a soft, damp cloth. Avoid harsh chemicals or acidic cleaners. We provide a specialized stone care guide with every marble purchase."
    },
    {
      question: "What is your white-glove delivery service?",
      answer: "Our white-glove team will deliver the furniture to your room of choice, assemble all pieces, and remove all packaging materials, ensuring a completely effortless experience."
    },
    {
      question: "Can I order fabric swatches before purchasing?",
      answer: "Absolutely. We offer a complimentary swatch kit containing our core bouclé, linen, and leather options to help you finalize your palette at home."
    }
  ]
};
