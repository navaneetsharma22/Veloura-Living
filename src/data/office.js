export const officeData = {
  ...
  customerStory: {
    quote: "Working from home used to feel like a compromise. Upgrading to the Apex Executive Desk completely shifted my mindset. The craftsmanship is inspiring, and the space now feels like a true corner office.",
    name: "David Chen",
  ...
  faqs: [
    {
      question: "How do I choose the right office desk?",
      answer: "Consider your daily workflow. If you primarily use a laptop, a sleek writing desk may suffice. If you review large documents or use multiple monitors, an executive L-shape or a desk with a depth of at least 30 inches is ideal."
    },
    {
      question: "Are your office chairs ergonomic?",
      answer: "Yes, our executive and task chairs feature hidden lumbar support, adjustable tension control, and high-density memory foam to ensure proper posture without sacrificing our signature aesthetic."
    },
    {
      question: "Can desks be customized?",
      answer: "We offer built-in cable management solutions, integrated power modules, and custom dimensioning on select executive collections."
    },
    {
      question: "What materials are best for daily use?",
      answer: "For writing and heavy daily use, we recommend our sealed oak or walnut finishes, which provide a smooth, resilient surface that resists scratching and moisture."
    },
    {
      question: "Do you offer workspace design consultations?",
      answer: "Yes, our design specialists can help you plan everything from a single home office to a complete corporate suite, ensuring optimal flow and aesthetic cohesion."
    }
  ]
};
